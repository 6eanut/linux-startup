...
* [ ] arch/riscv下的配置项所管理的代码的覆盖率
* [ ] arch/riscv下的代码被fuzz的覆盖率

2025-11-28

* [ ] (1)针对arch/riscv做静态分析，找到具有依赖的系统调用对：1.svf怎么找到具有依赖的读写语句的；2.怎么从读写语句映射到系统调用。
* [ ] (2)syzkaller所编写的syscall template中，为什么对x86那么多，对riscv那么少。
* [ ] (2)krepair应用到实际模糊测试中。
