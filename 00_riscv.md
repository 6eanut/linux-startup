...
> * 以上过程见[文档](00_riscv/docs/score_config.md)，见[代码](00_riscv/code/score_config.py)。
>
> 在动态方面：
>
...
>
> * [文件级配置项分析](00_riscv/docs/config_analyze.md)
> * [系统构建级配置项分析](00_riscv/docs/config_makefile.md)
> * [种子库复用](00_riscv/docs/corpus_reuse.md)
> * [配置项清单打分](00_riscv/docs/score_config.md)
