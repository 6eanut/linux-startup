...
CONFIG_TOOLCHAIN_HAS_ZACAS, CONFIG_RISCV_ISA_ZABHA, CONFIG_SYSFB, CONFIG_MODULE_SECTIONS, CONFIG_FUNCTION_TRACER, CONFIG_FUNCTION_GRAPH_TRACER, **CONFIG_FLATMEM(和NUMA互斥)**, CONFIG_DYNAMIC_FTRACE_WITH_DIRECT_CALLS, CONFIG_DYNAMIC_FTRACE_WITH_ARGS, CONFIG_DCACHE_WORD_ACCESS, CONFIG_CC_IS_CLANG, **CONFIG_BINFMT_ELF_FDPIC(和MMU互斥)**, CONFIG_AS_HAS_ULEB128

除了config_flatmem和config_binfmt_elf_fdpic等all也捋完了再说
